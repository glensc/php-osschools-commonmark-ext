...
echo $converter->convertToHtml("Test" . PHP_EOL . "```php" . PHP_EOL . "public function google() {" . PHP_EOL . "    return true;" . PHP_EOL . "}" . PHP_EOL . "```" . PHP_EOL . "https://google.com/store [Rhodes](https://rhodes.ml) matthew@google.net");